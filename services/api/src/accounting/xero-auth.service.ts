...
export class XeroAuthService {
  ...
  /**
   * Build the Xero authorize URL (admin "connect" stub).
   * state should be a CSRF token generated by the caller / session.
   */
  getConnectUrl(state: string): { url: string; scopes: readonly string[] } {
