...
export class AIController {
  ...
  @ApiOperation({ summary: 'Send AI chat message', description: 'Sends a message to an AI character and receives a response. Requires authentication.' })
  ...
  @Get('chat/history')
  @ApiOperation({ summary: 'Get chat history', description: 'Retrieves the chat history for the authenticated user, optionally filtered by character. Requires authentication.' })
  @ApiQuery({ name: 'characterId', required: false, type: String, description: 'Filter by character ID (optional)' })
  ...
  @Get('recommendations')
  @ApiOperation({ summary: 'Get personalized recommendations', description: 'Retrieves AI-powered personalized product recommendations for the authenticated user. Requires authentication.' })
