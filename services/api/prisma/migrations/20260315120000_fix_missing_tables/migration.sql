-- Emergency migration: create tables/columns/enums that prior migrations
-- may have failed to apply. Every statement is idempotent.
...
-- Merge catalog marketing pipeline
DO $$ BEGIN UPDATE "product_submissions" SET "status" = 'CONTENT_COMPLETED' WHERE "status" = 'MARKETING_COMPLETED'; EXCEPTION WHEN OTHERS THEN NULL; END $$;
