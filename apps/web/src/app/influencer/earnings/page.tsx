        ...
        <div className="bg-hos-bg-secondary rounded-xl shadow-sm overflow-hidden">
          ...
          {commissions.length === 0 ? (
            <div className="p-12 text-center">
              ...
              <p className="text-hos-text-muted">No commissions yet</p>
            </div>
          ) : (
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-hos-text-muted">
                        <span className="flex items-center gap-1">
                          ...
                          <span className={`text-xs px-1.5 py-0.5 rounded ${
                            commission.rateSource === 'CAMPAIGN' ? 'bg-hos-gold/20 text-hos-gold-hover' :
                            commission.rateSource === 'CATEGORY' ? 'bg-hos-gold/20 text-hos-gold' :
