    ...
    <div className="min-h-screen bg-hos-bg-secondary">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
        ...
        <div className="max-w-3xl mx-auto space-y-6 sm:space-y-8">
          ...
          <section className="bg-hos-gold/10 border border-hos-border-accent rounded-xl p-6 sm:p-8">
            ...
            <Link
              href="/support/new"
              className="inline-flex items-center gap-2 px-6 py-2.5 bg-hos-gold text-[#1a1406] rounded-lg hover:bg-hos-gold-hover font-medium transition-colors"
            >
          ...
          <section>
            ...
            <p className="text-sm sm:text-base text-hos-text-secondary mb-3 sm:mb-4">
