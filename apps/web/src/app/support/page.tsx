...
export default function SupportPage() {
  ...
  const fetchTickets = async () => {
    try {
      setLoading(true);
      const response = await apiClient.getSupportTickets({ userId: user?.id });
      if (response?.data) {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
        <div className="max-w-6xl mx-auto">
          <div className="mb-6">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2">Customer Support</h1>
          ...
          {!isAuthenticated && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <p className="text-blue-800">
                Please <Link href="/login" className="font-semibold underline">login</Link> to create and view support tickets.
              </p>
            </div>
          )}
          ...
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-xl font-semibold mb-4">AI Support Assistant</h2>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Link href="/help" className="text-sm text-purple-600 hover:text-purple-700">
                    Visit Help Center →
                  </Link>
                </div>
              </div>
