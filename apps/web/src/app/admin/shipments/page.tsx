          ...
          {stats && (
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-3">
              ...
              <button
                ...
                className={`bg-hos-bg-secondary rounded-lg shadow p-3 text-left hover:shadow-md ${statusFilter === 'IN_TRANSIT' ? 'ring-2 ring-hos-gold/50' : ''}`}
              >
                <p className="text-xs text-hos-text-muted">In Transit</p>
                <p className="text-xl font-bold text-hos-gold">{stats.inTransit}</p>
              </button>
              <button
              ...
              <button
                ...
                className={`bg-hos-bg-secondary rounded-lg shadow p-3 text-left hover:shadow-md ${statusFilter === 'RETURNED' ? 'ring-2 ring-hos-gold/50' : ''}`}
              >
                <p className="text-xs text-hos-text-muted">Returned</p>
                <p className="text-xl font-bold text-hos-text-secondary">{stats.returned}</p>
              </button>
              <div className="bg-hos-bg-secondary rounded-lg shadow p-3">
                <p className="text-xs text-hos-text-muted">Avg Delivery</p>
                <p className="text-xl font-bold text-hos-gold">{stats.avgDeliveryDays}d</p>
              </div>
            </div>
          )}
                        ...
                        <tr key={shipment.id} className="hover:bg-hos-bg-tertiary">
                          ...
                          <td className="px-4 py-3">
                            ...
                            {shipment.order?.customer && (
                              <div className="text-xs text-hos-text-muted">{shipment.order.customer.email}</div>
                            )}
                          </td>
                          ...
                          <td className="px-4 py-3">
                            {shipment.trackingNumber ? (
                              ...
                              <span className="text-sm text-hos-text-muted">Not available</span>
                            )}
                          </td>
                ...
                <div className="p-6">
                  <div className="flex justify-between items-start mb-6">
                    <div>
                      ...
                      <p className="text-sm text-hos-text-muted">ID: {selectedShipment.id}</p>
                    </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <p className="text-sm text-hos-text-muted">Carrier</p>
                        <p className="font-medium">{selectedShipment.carrier || 'Not assigned'}</p>
                      </div>
                      <div>
                        <p className="text-sm text-hos-text-muted">Tracking Number</p>
                      ...
                      {selectedShipment.weight && (
                        <div>
                          <p className="text-sm text-hos-text-muted">Weight</p>
                    ...
                    {selectedShipment.notes && (
                      <div>
                        <p className="text-sm text-hos-text-muted">Notes</p>
                        <p className="text-hos-text-secondary">{selectedShipment.notes}</p>
                      </div>
                    )}
              ...
              <div className="bg-hos-bg-secondary rounded-lg max-w-md w-full">
                <div className="p-6">
                  <div className="flex justify-between items-start mb-6">
                    ...
                    <button onClick={() => setShowUpdateModal(false)} className="text-hos-text-muted hover:text-hos-text-secondary text-2xl">×</button>
                  </div>
