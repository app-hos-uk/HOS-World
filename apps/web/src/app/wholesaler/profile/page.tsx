      ...
      <DashboardLayout role="WHOLESALER" menuItems={menuItems} title="Wholesaler">
        <div className="space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Wholesaler Profile</h1>
              <p className="text-gray-600 mt-1">Manage your wholesale business information and settings</p>
            </div>
