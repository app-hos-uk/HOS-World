  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-12">
          ...
          <div>
            ...
            <form onSubmit={handleNewsletterSubmit} className="space-y-2">
              <input
                ...
                required
                className="w-full px-3 py-2 rounded border focus:outline-none focus:ring-2 focus:ring-accent"
                style={{
        ...
        <div className="pt-8 border-t text-center" style={{ borderColor: theme.colors.secondary }}>
