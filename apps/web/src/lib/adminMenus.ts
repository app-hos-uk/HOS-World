...
export const menuItems: ShellMenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { title: 'Settings', href: '/admin/loyalty/settings', icon: navIcon('settings') },
      ...
      { title: 'POS Vouchers', href: '/admin/loyalty/pos-vouchers', icon: navIcon('ticket') },
  ...
  // --- Operations ---
  {
    ...
    children: [
      ...
      { title: 'Loyalty Liability', href: '/admin/loyalty/liability', icon: navIcon('scale') },
      { title: 'Xero Export (optional)', href: '/admin/finance/accounting', icon: navIcon('bookOpen') },
  ...
  },
  {
    ...
    children: [
      ...
      { title: 'Role Assignments', href: '/admin/role-assignments', icon: navIcon('clipboard') },
      { title: 'Markets', href: '/admin/markets', icon: navIcon('store') },
      { title: 'Access Control', href: '/admin/access-control', icon: navIcon('shield') },
