 ...
 * `--font-*` variables consumed by `globals.css`, `landing.css` and `tailwind.config.js`.
 *
...
/** Storefront display headings & marketing body. */
export const cormorant = localFont({
  src: [
    ...
    {
      path: '../../node_modules/@fontsource/cormorant-garamond/files/cormorant-garamond-latin-700-italic.woff2',
      weight: '700',
      style: 'italic',
    },
  ],
...
/** Dashboards, forms, tables, and storefront UI chrome (nav/buttons). */
...
/**
 * Landing body face. Separate from `cormorant` above: the landing route group scopes its
 * own `--font-cormorant-landing` variable and uses a lighter weight range.
 */
export const cormorantLanding = localFont({
  src: [
    {
